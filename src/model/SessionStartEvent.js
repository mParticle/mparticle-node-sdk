...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.mParticle.SessionStartEvent = factory(root.mParticle.ApiClient, root.mParticle.DeviceCurrentState, root.mParticle.EventData, root.mParticle.GeoLocation, root.mParticle.EventBase);
  }
  ...
  /**
   * The SessionStartEvent model module.
   * @module model/SessionStartEvent
   * @version 1.0.1
   */

  /**
   * Constructs a new <code>SessionStartEvent</code>.
   * @alias module:model/SessionStartEvent
   * @class
  ...
  /**
   * Constructs a <code>SessionStartEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SessionStartEvent} obj Optional instance to populate.
   * @return {module:model/SessionStartEvent} The populated <code>SessionStartEvent</code> instance.
   */
  ...
  exports.prototype['getEventType'] = function() {
    return EventBase.EventType.session_start;
  }
