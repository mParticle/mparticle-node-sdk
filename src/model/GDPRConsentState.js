...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.mParticle.GDPRConsentState = factory(root.mParticle.ApiClient);
  }
})(this, function(ApiClient) {
  'use strict';

  /**
   * The GDPRConsentState model module
   * @module model/GDPRConsentState
   * @version 1.0.0
   */
  ...
  /**
   * Constructs a <code>GDPRConsentState</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GDPRConsentState} obj Optional instance to populate.
   * @return {module:model/GDPRConsentState} The populated <code>GDPRConsentState</code> instance.
   */
