...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mParticle.MediaInfo();
  });
  ...
  describe('MediaInfo', function() {
    it('should create an instance of MediaInfo', function() {
      var instance = new mParticle.MediaInfo();
      expect(instance).to.be.a(mParticle.MediaInfo);
    });
