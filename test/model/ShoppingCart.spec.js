...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new mParticle.ShoppingCart();
  });
  ...
  describe('ShoppingCart', function() {
    it('should create an instance of ShoppingCart', function() {
      var instance = new mParticle.ShoppingCart();
      expect(instance).to.be.a(mParticle.ShoppingCart);
    });

    it('should have the property products (base name: "products")', function() {
      var products = [
        new mParticle.Product()
      ];
      var instance = new mParticle.ShoppingCart(products);
